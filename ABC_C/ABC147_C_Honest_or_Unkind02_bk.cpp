...
{
//cout <<"### cnrvnHonest[" << nMan << "] = " << cnrvnHonest[nMan] << endl;
  if (cnrvnHonest[nMan])               // Honest
  {
    for (int j = 0; j < cnrvvoExpr[nMan].size(); j++)
      ...
      {
/*      cout << "### cnrvvoExpr[" << nMan << "][" << j << "] = " << cnrvvoExpr[nMan][j].m_nAttr << endl;
        cout << "### cnrvnHonest[" << cnrvvoExpr[nMan][j].m_nPerson << "] = ";
*/      cout << cnrvnHonest[ cnrvvoExpr[nMan][j].m_nPerson ] << endl;
        return 0;
      }
  }
  else                                 // UnKind
...
//  cout << "### nMaxHonestCnt = " << nMaxHonestCnt << endl;
  }
